...
class StoryBlock(models.Model):
	...
	block_image = models.URLField(default='https://via.placeholder.com/150', verbose_name='storyblock image URL')
	...
	block_text = models.TextField(verbose_name='storyblock text', default='text')
	prev_block_sub = models.PositiveIntegerField(default=1)
	prev_block_txt = models.CharField(max_length=32, default='return', verbose_name='return to previous block button text')
	next_block1_add = models.PositiveIntegerField(default=1)
	next_block1_txt = models.CharField(max_length=32, default='go left', verbose_name='choice 1 button text')
	next_block2_add = models.PositiveIntegerField(default=1)
	next_block2_txt = models.CharField(max_length=32, default='go right', verbose_name='choice 2 button text')
