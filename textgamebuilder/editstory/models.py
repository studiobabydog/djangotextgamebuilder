...
class StoryBlock(models.Model):
	...
	prev_block_slug = models.SlugField(null=True, default='block-slug', verbose_name='previous storyblock slug')
	prev_block_txt = models.CharField(null=True, max_length=32, default='return', verbose_name='previous storyblock button text')
	next_block1_slug = models.SlugField(null=True, default='block-slug', verbose_name='choice 1 storyblock slug')
	next_block1_txt = models.CharField(null=True, max_length=32, default='go left', verbose_name='choice 1 button text')
	next_block2_slug = models.SlugField(null=True, default='block-slug', verbose_name='choice 2 storyblock slug')
	next_block2_txt = models.CharField(null=True, max_length=32, default='go right', verbose_name='choice 2 button text')
